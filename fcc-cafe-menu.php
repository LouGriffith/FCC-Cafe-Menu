...
require_once FCC_MENU_DIR . 'includes/class-bricks-dynamic-tags.php';
require_once FCC_MENU_DIR . 'includes/class-menu-shortcode-v1.2.php';
...
FCC_Menu_Bricks_Tags::get_instance();
